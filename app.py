...
# dev env
app.config['MYSQL_DATABASE_USER'] = 'julianodev'
app.config['MYSQL_DATABASE_PASSWORD'] = 'chilledmonkeybra1ns'
app.config['MYSQL_DATABASE_DB'] = 'julianonyc_glimpse'
app.config['MYSQL_DATABASE_HOST'] = 'mysql.juliano.nyc'
